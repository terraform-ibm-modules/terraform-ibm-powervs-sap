...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_power-infrastructure"></a> [power-infrastructure](#module\_power-infrastructure) | git::https://github.com/terraform-ibm-modules/terraform-ibm-powervs-infrastructure.git | v4.0.0 |
