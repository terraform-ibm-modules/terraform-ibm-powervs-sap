...
| <a name="input_sap_hana_hostname"></a> [sap\_hana\_hostname](#input\_sap\_hana\_hostname) | SAP HANA hostname (non FQDN). If specified - will get the form of <prefix>-<sap\_hana\_hostname>. | `string` | `"hana"` | no |
...
| <a name="input_sap_hana_profile"></a> [sap\_hana\_profile](#input\_sap\_hana\_profile) | SAP HANA profile to use. Must be one of the supported profiles. See XXX. | `string` | `"cnp-2x64"` | no |
...
| <a name="input_sap_netweaver_hostname"></a> [sap\_netweaver\_hostname](#input\_sap\_netweaver\_hostname) | SAP Netweaver hostname (non FQDN). If specified - will get the form of <prefix>-<sap\_netweaver\_hostname>-<number>. | `string` | `"nw"` | no |
