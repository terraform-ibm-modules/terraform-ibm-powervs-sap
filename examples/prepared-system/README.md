...
| <a name="input_additional_networks"></a> [additional\_networks](#input\_additional\_networks) | Additional existing private networks that will be attached to IBM PowerVS instances. | `list(string)` | <pre>[<br>  "mgmt_net",<br>  "bkp_net"<br>]</pre> | no |
...
| <a name="input_dns_host_or_ip"></a> [dns\_host\_or\_ip](#input\_dns\_host\_or\_ip) | Private IP address of DNS server, resolver or forwarder. | `string` | `""` | no |
...
| <a name="input_nfs_host_or_ip"></a> [nfs\_host\_or\_ip](#input\_nfs\_host\_or\_ip) | Private IP address of NFS server. | `string` | `""` | no |
| <a name="input_nfs_path"></a> [nfs\_path](#input\_nfs\_path) | NFS directory on NFS server. | `string` | `"/nfs"` | no |
| <a name="input_ntp_host_or_ip"></a> [ntp\_host\_or\_ip](#input\_ntp\_host\_or\_ip) | Private IP address of NTP time server or forwarder. | `string` | `""` | no |
...
| <a name="input_proxy_host_or_ip"></a> [proxy\_host\_or\_ip](#input\_proxy\_host\_or\_ip) | Private IP address of proxy server. | `string` | n/a | yes |
...
| <a name="input_resource_group_name"></a> [resource\_group\_name](#input\_resource\_group\_name) | An existing resource group name to use for this example | `string` | n/a | yes |
| <a name="input_sap_domain_name"></a> [sap\_domain\_name](#input\_sap\_domain\_name) | Default network domain name for all IBM powerVS instances. May be overwritten by individual instance configurations. | `string` | n/a | yes |
...
| <a name="input_sap_hana_ip"></a> [sap\_hana\_ip](#input\_sap\_hana\_ip) | Optional SAP HANA IP address (in SAP system network). | `string` | `""` | no |
| <a name="input_sap_hana_profile"></a> [sap\_hana\_profile](#input\_sap\_hana\_profile) | SAP HANA profile to use. Must be one of the supported profiles. | `string` | n/a | yes |
...
| <a name="input_sap_netweaver_instance_number"></a> [sap\_netweaver\_instance\_number](#input\_sap\_netweaver\_instance\_number) | Number of SAP for SAP NetWeaver instances that should be created. | `number` | `1` | no |
| <a name="input_sap_netweaver_ips"></a> [sap\_netweaver\_ips](#input\_sap\_netweaver\_ips) | List of optional SAP NetWeaver IP addresses (in SAP system network). | `list(string)` | `[]` | no |
...
| <a name="input_ssh_private_key"></a> [ssh\_private\_key](#input\_ssh\_private\_key) | Private SSH key used to login to IBM PowerVS instances. Should match to uploaded public SSH key referenced by 'pvs\_sshkey\_name'. | `string` | n/a | yes |
