...
locals {
  ...
  powervs_share_hostname            = var.sap_share_instance_config["hostname"] != null && var.sap_share_instance_config["hostname"] != "" ? var.sap_share_instance_config["hostname"] : "${var.prefix}-share"
  #powervs_share_domain               = var.sap_share_instance_config["domain"] != null && var.sap_share_instance_config["domain"] != "" ? var.sap_share_instance_config["domain"] : var.sap_domain_name
  ...
  powervs_hana_hostname         = var.sap_hana_instance_config["hostname"] != null && var.sap_hana_instance_config["hostname"] != "" ? var.sap_hana_instance_config["hostname"] : "${var.prefix}-${var.sap_hana_hostname}"
  #powervs_hana_domain           = var.sap_hana_instance_config["domain"] != null && var.sap_hana_instance_config["domain"] != "" ? var.sap_hana_instance_config["domain"] : var.sap_domain_name
  ...
  powervs_netweaver_hostname            = var.sap_netweaver_instance_config["hostname"] != null && var.sap_netweaver_instance_config["hostname"] != "" ? var.sap_netweaver_instance_config["hostname"] : "${var.prefix}-${var.sap_netweaver_hostname}"
  #powervs_netweaver_domain               = var.sap_netweaver_instance_config["domain"] != null && var.sap_netweaver_instance_config["domain"] != "" ? var.sap_netweaver_instance_config["domain"] : var.sap_domain_name
