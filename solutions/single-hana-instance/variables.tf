...
variable "powervs_zone" {
  ...
  type        = string
  validation {
    condition     = contains(["syd04", "syd05", "eu-de-1", "eu-de-2", "lon04", "lon06", "tok04", "us-east", "us-south", "dal10", "dal12", "dal14", "tor01", "osa21", "sao01", "sao04", "sao05", "mon01", "wdc06", "wdc07", "che01", "mad02", "mad04", "wdc06-pvs-01", "che02", "che03"], var.powervs_zone)
    error_message = "Only Following DC values are supported :  syd04, syd05, eu-de-1, eu-de-2, lon04, lon06, tok04, us-east, us-south, dal10, dal12, dal14, tor01, osa21, sao01, sao04, sao05, mon01, wdc06, wdc07,che01, mad02, mad04, wdc06-pvs-01, che02, che03"
  }
}
