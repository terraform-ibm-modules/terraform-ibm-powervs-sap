...
| <a name="input_powervs_netweaver_instance_number"></a> [powervs\_netweaver\_instance\_number](#input\_powervs\_netweaver\_instance\_number) | Number of SAP NetWeaver instances that should be created. | `number` | `1` | no |
