...
| Name | Type |
|------|------|
| [ibm_pi_image.powervs_hana_os_image](https://registry.terraform.io/providers/IBM-Cloud/ibm/1.74.0/docs/data-sources/pi_image) | data source |
| [ibm_pi_image.powervs_netweaver_os_image](https://registry.terraform.io/providers/IBM-Cloud/ibm/1.74.0/docs/data-sources/pi_image) | data source |
...
| <a name="input_powervs_os_registration"></a> [powervs\_os\_registration](#input\_powervs\_os\_registration) | If you're using a byol or a custom RHEL/SLES image for SAP HANA and Netweaver you need to provide your OS registration credentials here. Leave empty if you're using an IBM provided subscription (FLS). | <pre>object({<br/>    username = string<br/>    password = string<br/>  })</pre> | <pre>{<br/>  "password": "",<br/>  "username": ""<br/>}</pre> | no |
