...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_ansible_install_webdispatcher"></a> [ansible\_install\_webdispatcher](#module\_ansible\_install\_webdispatcher) | ../../../modules/ansible | n/a |
...
| <a name="module_ibmcloud_cos_download_webdispatcher_binaries"></a> [ibmcloud\_cos\_download\_webdispatcher\_binaries](#module\_ibmcloud\_cos\_download\_webdispatcher\_binaries) | ../../../modules/ibmcloud-cos | n/a |
...
| <a name="input_enable_webdispatcher"></a> [enable\_webdispatcher](#input\_enable\_webdispatcher) | Whether to provision the Terraform-managed Web Dispatcher VSI+ALB group (2 VSIs, dedicated subnet/security group, TCP-passthrough ALB) via the landing-zone module's opt-in feature. | `bool` | `false` | no |
...
| <a name="input_sap_webdisp_vars"></a> [sap\_webdisp\_vars](#input\_sap\_webdisp\_vars) | SAP Web Dispatcher SID and instance number. | <pre>object({<br/>    sap_swpm_webdisp_sid         = string<br/>    sap_swpm_webdisp_instance_nr = string<br/>  })</pre> | <pre>{<br/>  "sap_swpm_webdisp_instance_nr": "21",<br/>  "sap_swpm_webdisp_sid": "WFP"<br/>}</pre> | no |
...
| <a name="input_webdispatcher_listener_port"></a> [webdispatcher\_listener\_port](#input\_webdispatcher\_listener\_port) | ALB listener port for Web Dispatcher traffic (also the backend pool member + health-check port). Must equal 443<sap\_webdisp\_vars.sap\_swpm\_webdisp\_instance\_nr> — SAP's own convention for Web Dispatcher's HTTPS port — since the SAP-side port isn't independently configurable. | `number` | `44321` | no |
...
| <a name="output_sap_webdispatcher_vars"></a> [sap\_webdispatcher\_vars](#output\_sap\_webdispatcher\_vars) | SAP Web Dispatcher details: whether enabled, SID/instance number, and the 2 provisioned VSIs' private IPs (empty list when enable\_webdispatcher is false). |
