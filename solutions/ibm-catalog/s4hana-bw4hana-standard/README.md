...
| <a name="input_cos_service_credentials"></a> [cos\_service\_credentials](#input\_cos\_service\_credentials) | Cloud object storage Instance service credentials to access the cos bucket [a json example of a service credential](https://cloud.ibm.com/docs/cloud-object-storage?topic=cloud-object-storage-service-credentials) | `string` | n/a | yes |
