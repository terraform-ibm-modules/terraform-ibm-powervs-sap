...
| <a name="input_cos_configuration"></a> [cos\_configuration](#input\_cos\_configuration) | COS details to download the files to the target host | <pre>object({<br>    cos_apikey               = string<br>    cos_region               = string<br>    cos_resource_instance_id = string<br>    cos_bucket_name          = string<br>    cos_hanadb_path          = string<br>  })</pre> | n/a | yes |
