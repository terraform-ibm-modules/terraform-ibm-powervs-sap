...
This variation requires an existing IBM Cloud Object Storage (COS) instance. Within the instance must be an Object Storage Bucket containing the SAP Software installation media files is required in the correct folder structure as defined [here]().[TODO add link]
